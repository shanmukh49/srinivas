class Login4Controller < ApplicationController
   require 'digest/sha2'
  ...
  def login_page  
    ...
    username = params[:user_from_login4]
    pw_from_login = params[:pw_from_login4]
  ...
  def logout
    ...
    redirect_to :controller => 'login4', :action => 'login_page'
