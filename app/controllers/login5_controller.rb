class Login5Controller < ApplicationController
  require 'digest/sha2'
  ...
  def login_page  
    ...
    username = params[:user_from_login5]
    pw_from_login = params[:pw_from_login5]
  ...
  def logout
    ...
    redirect_to :controller => 'login5', :action => 'login_page'
