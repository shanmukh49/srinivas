class Applicant < ActiveRecord::Base
  ...
  attr_accessible :email, :interviewers, :name, :role, :round, :scheduleofinterview, :sourcingpartner, :status, :technology, :cv, :lname, :mobile, :education
  ...
  validates_attachment_content_type :cv,
    ...
    :message => "Wrong Format" }
        validates_presence_of :email, :mobile,:lname,:education,:interviewers, :name, :role, :round, :scheduleofinterview, :sourcingpartner, :status, :technology, :cv
